...
class InfiniteLoopingCubicTaskCluster(InfiniteLoopingTask):
    ...
    def loop(self, *args, **kwargs):
        ...
        if start_step in [None, self.steps[0]]:
            ...
            self.last_loop_state['prepare_cluster_return_code'] = prepare_cluster()
        ...
        if start_step in [None, self.steps[6]]:
            self.last_loop_state['wait_fem_gen_return_code'] = wait_for_cluster()
