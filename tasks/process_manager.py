...
from tasks.infinite_looping_cubic_task import InfiniteLoopingCubicTask
...
class ProcessesManager:
    ...
    def intercept_fem_task(self, **kwargs):
        ...
        # Should catch exception before running process, because exception
        # cathcing of a process outside itself is not possible unfortunately.
        try:
